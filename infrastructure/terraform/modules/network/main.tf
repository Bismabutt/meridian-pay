...
# ------------------------------------------------------------
# Internet Gateway — the door to the internet for public subnets
# ------------------------------------------------------------
...
resource "aws_subnet" "public" {
  ...
  tags = {
    ...
    Tier = "public"
    # Required by the AWS Load Balancer Controller to place internet-facing ALBs
...
resource "aws_subnet" "private" {
  ...
  tags = {
    ...
    Tier = "private"
    # Required by the AWS Load Balancer Controller for internal load balancers
